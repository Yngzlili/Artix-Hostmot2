...
set_property PACKAGE_PIN t10 [get_ports COM_SPICLK]
set_property IOSTANDARD LVTTL [get_ports COM_SPICLK]

set_property PACKAGE_PIN r11 [get_ports COM_SPICS]
set_property IOSTANDARD LVTTL [get_ports COM_SPICS]

set_property PACKAGE_PIN t9 [get_ports COM_SPIIN]
set_property IOSTANDARD LVTTL [get_ports COM_SPIIN]

set_property PACKAGE_PIN r10 [get_ports COM_SPIOUT]
...
set_property PACKAGE_PIN c1 [get_ports {ADC_MUXP[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ADC_MUXP[0]}]

set_property PACKAGE_PIN b1 [get_ports {ADC_MUXP[1]}]
